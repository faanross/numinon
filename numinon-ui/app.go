...
// GetServerMessageModel is a dummy function to ensure the ServerMessage model is generated by Wails.
func (a *App) GetServerMessageModel() models.ServerMessage {
